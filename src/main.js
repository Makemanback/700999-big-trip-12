...
const createPageFiltersTemplate = () => {
  return (
...
const createPageTripInfoTemplate = () => {
  return (
...
const createPageInfoCostTemplate = () => {
  return (
...
const createPageTripEditTemplate = () => {
  return (
...
const createPageTripDaysListTemplate = () => {
  return (
    `<ul class="trip-days">
    </ul>`
  );
