...
const createDescription = (city, description, photo) => {
...
const createPageTripEditTemplate = ({additionals, price, type, city, isFavorite, schedule, pointInfo}) => {
  const favoriteHandler = isFavorite ? `checked` : ``;
  ...
  return (
    `<li class="trip-events__item">
      ...
      <header class="event__header">
        ...
        <input id="event-favorite-1" class="event__favorite-checkbox  visually-hidden" type="checkbox" name="event-favorite" ${favoriteHandler}>
